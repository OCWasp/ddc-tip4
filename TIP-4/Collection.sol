...
contract Collection is TIP4_2Collection, TIP4_3Collection, OwnableExternal, ITokenBurned, Charge {
    ...
    **/
    ...
    function getFunctionIds(string functionName) external virtual returns (bytes4) {
        mapping(string => bytes4) functionIds;
        ...
        functionIds['mintNft'] = "1";
        functionIds['bMintNft'] = "2";
        functionIds['transfer'] = "3";
        functionIds['changeOwner'] = "4";
        functionIds['changeManager'] = "5";
        functionIds['burn'] = "6";
        return functionIds[functionName];
    }

    function transferEvent(address operator, address owner, uint256 ddcId) external {
        emit Transfer(operator, address(0), owner, ddcId);
    }
